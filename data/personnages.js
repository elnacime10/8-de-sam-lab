...
const LINES = {
  ...
  mehmet: {
    ...
    hit : [{t:"Wesh c'est quoi ça ?!",c:"Non mais c'est quoi ça ?"},
           ...
           {t:"Nan mais c'est pas possible.",c:"Nan mais c'est pas possible."}],
    ...
    lose: [{t:"J'joue plus. J'JOUE PLUS.",c:"Je joue plus. JE JOUE PLUS."},
           {t:"Vous êtes des voleurs.",c:"Vous êtes des voleurs."}]
  },
  hamza: {
    ...
    hit : [{t:"Même pas mal ahahah !",c:"Même pas mal ahahah !"},
           {t:"J'suis dans le game, j'suis dans le game.",c:"J'suis dans le game, j'suis dans le game."}],
  ...
  yuns: {
    atk : [{t:"Tiens.",c:"Tiens."},{t:"Voilà.",c:"Voilà."},{t:"Ramasse.",c:"Ramasse."}],
    hit : [{t:"Mouais.",c:"Mouais."},{t:"Ouais bon.",c:"Ouais, bon."}],
    low : [{t:"Ah. Tiens.",c:"Ah. Tiens."},
           {t:"Ça sent pas bon pour toi.",c:"Ça sent pas bon pour toi."}],
    out : [{t:"C'est bon j'ai fini.",c:"C'est bon, j'ai fini."}],
    lose: [{t:"J'm'en bats les couilles.",c:"J'm'en fiche complètement."}]
  },
  nacime: {
    atk : [{t:"Sale mouillé.",c:"Allez, doucement."},
